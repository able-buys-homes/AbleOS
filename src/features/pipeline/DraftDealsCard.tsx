              ...
              <div className="min-h-0 flex-1 overflow-y-auto p-4">
                ...
                {active && form && (
                  <div className="space-y-3">
                    ...
                    {/* Read-only on purpose. This is what the seller actually
                        submitted - correcting it here would quietly rewrite
                        their words. Raj's own fields are below and editable. */}
                    {active.origin === "website" && (
                      <div className="rounded-2xl border border-[#DCE4EE] bg-white p-4">
                        <div className="text-[14px] font-semibold uppercase tracking-wide text-[#7A8AA3]">
                          What they submitted
                          ...
                          {(
                            ...
                            .map(([label, value]) => (
                              <div className="flex justify-between gap-4" key={label}>
                                <dt className="shrink-0 text-[#7A8AA3]">{label}</dt>
                                <dd className="min-w-0 break-words text-right font-medium text-[#0F1E33]">
                                  {value}
                                </dd>
                              </div>
                            ))}
                        ...
                        {active.notes && (
                          <div className="mt-3 border-t border-[#F1F5F9] pt-3">
                            ...
                            <p className="mt-1 whitespace-pre-line text-[16px] leading-relaxed text-[#3A4A62]">
                              {active.notes}
                            </p>
                          </div>
                        )}
